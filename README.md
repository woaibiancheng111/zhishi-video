...
- **学习路线** - 提供结构化的专属视频学习路线图，可视化的学习进度打卡
- **学习统计** - 追踪学习行为，展示学习数据
- **创作者中心** - 赋能讲师/内容创作者，拥有独立数据看板与视频管理能力
...
│       │   ├── Home.jsx        # 首页推荐Feed
│       │   ├── Category.jsx    # 分类浏览
│       │   ├── Roadmaps.jsx    # 学习路线图列表
│       │   ├── RoadmapDetail.jsx # 学习路线图详情
│       │   ├── CreatorStudio.jsx # 创作者数据看板与视频管理
│       │   ├── Search.jsx      # 搜索
...
| 方法 | 路径 | 说明 |
|------|------|------|
| GET | /api/v1/roadmaps | 获取系统学习路线图列表 |
| GET | /api/v1/roadmaps/:id | 获取指定路线图详情与个人进度（需登录） |

### 创作者中心接口

| 方法 | 路径 | 说明 |
|------|------|------|
| GET | /api/v1/creator/stats | 创作者宏观数据看板（播放数、点赞数统计） |
| GET | /api/v1/creator/videos | 创作者个人视频管理列表分页查询 |
